/****************************************************************************************************************************
  AsyncESP32_SC_W6100_Manager_Impl.h
  ...
  Built by Khoi Hoang https://github.com/khoih-prog/AsyncESP32_SC_W6100_Manager
  ...
  ------- -----------  ---------- -----------
  1.1.0   K Hoang     14/01/2023 Initial coding for ESP32_S3_W6100 (ESP32_S2/S3/C3 + LwIP W6100)
 *****************************************************************************************************************************/

#pragma once

#ifndef AsyncESP32_SC_W6100_Manager_Impl_h
#define AsyncESP32_SC_W6100_Manager_Impl_h
...
/**
   ...
   @access public
*/
ESPAsync_EMParameter** AsyncESP32_SC_W6100_Manager::getParameters()
{
  return _params;
}
...
/**
   ...
   @access public
*/
int AsyncESP32_SC_W6100_Manager::getParametersCount()
{
  return _paramsCount;
}
...
char* AsyncESP32_SC_W6100_Manager::getRFC952_hostname(const char* iHostname)
{
...
AsyncESP32_SC_W6100_Manager::AsyncESP32_SC_W6100_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver,
...
AsyncESP32_SC_W6100_Manager::~AsyncESP32_SC_W6100_Manager()
{
#if USE_DYNAMIC_PARAMS
...
#if USE_DYNAMIC_PARAMS
  bool AsyncESP32_SC_W6100_Manager::addParameter(ESPAsync_EMParameter *p)
#else
  void AsyncESP32_SC_W6100_Manager::addParameter(ESPAsync_EMParameter *p)
#endif
{
#if USE_DYNAMIC_PARAMS
...
void AsyncESP32_SC_W6100_Manager::setupConfigPortal()
{
  ...
  server->on("/",         std::bind(&AsyncESP32_SC_W6100_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/eth",     std::bind(&AsyncESP32_SC_W6100_Manager::handleETH,        this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/ethsave", std::bind(&AsyncESP32_SC_W6100_Manager::handleETHSave,    this,
                                   std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/close",    std::bind(&AsyncESP32_SC_W6100_Manager::handleServerClose, this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/i",        std::bind(&AsyncESP32_SC_W6100_Manager::handleInfo,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/r",        std::bind(&AsyncESP32_SC_W6100_Manager::handleReset,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->on("/state",    std::bind(&AsyncESP32_SC_W6100_Manager::handleState,       this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  //Microsoft captive portal. Maybe not needed. Might be handled by notFound handler.
  server->on("/fwlink",   std::bind(&AsyncESP32_SC_W6100_Manager::handleRoot,        this,
                                    std::placeholders::_1)).setFilter(ON_AP_FILTER);
  server->onNotFound (std::bind(&AsyncESP32_SC_W6100_Manager::handleNotFound,        this, std::placeholders::_1));
...
bool AsyncESP32_SC_W6100_Manager::startConfigPortal()
{
  connect = false;
...
void AsyncESP32_SC_W6100_Manager::setTimeout(const unsigned long& seconds)
{
...
void AsyncESP32_SC_W6100_Manager::setConfigPortalTimeout(const unsigned long& seconds)
{
...
void AsyncESP32_SC_W6100_Manager::setConnectTimeout(const unsigned long& seconds)
{
  _connectTimeout = seconds * 1000;
}

void AsyncESP32_SC_W6100_Manager::setDebugOutput(bool debug)
{
  _debug = debug;
}
...
void AsyncESP32_SC_W6100_Manager::setBreakAfterConfig(bool shouldBreak)
{
...
void AsyncESP32_SC_W6100_Manager::reportStatus(String& page)
{
...
void AsyncESP32_SC_W6100_Manager::setSTAStaticIPConfig(const IPAddress& ip, const IPAddress& gw, const IPAddress& sn)
{
...
void AsyncESP32_SC_W6100_Manager::setSTAStaticIPConfig(const ETH_STA_IPConfig& EM_STA_IPconfig)
{
  LOGINFO(F("setSTAStaticIPConfig"));
...
void AsyncESP32_SC_W6100_Manager::getSTAStaticIPConfig(ETH_STA_IPConfig& EM_STA_IPconfig)
{
...
void AsyncESP32_SC_W6100_Manager::handleRoot(AsyncWebServerRequest *request)
{
...
void AsyncESP32_SC_W6100_Manager::handleETH(AsyncWebServerRequest *request)
{
...
void AsyncESP32_SC_W6100_Manager::handleETHSave(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("ETH save"));
...
void AsyncESP32_SC_W6100_Manager::handleServerClose(AsyncWebServerRequest *request)
{
...
void AsyncESP32_SC_W6100_Manager::handleInfo(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Info"));
  ...
  page += F("<p/>More information about AsyncESP32_SC_W6100_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/AsyncESP32_SC_W6100_Manager\">https://github.com/khoih-prog/AsyncESP32_SC_W6100_Manager</a>");
  page += FPSTR(EM_HTTP_END);
...
void AsyncESP32_SC_W6100_Manager::handleState(AsyncWebServerRequest *request)
{
...
void AsyncESP32_SC_W6100_Manager::handleReset(AsyncWebServerRequest *request)
{
  LOGDEBUG(F("Reset"));
...
void AsyncESP32_SC_W6100_Manager::handleNotFound(AsyncWebServerRequest *request)
{
  if (captivePortal(request))
  {
...
*/
bool AsyncESP32_SC_W6100_Manager::captivePortal(AsyncWebServerRequest *request)
{
...
void AsyncESP32_SC_W6100_Manager::setSaveConfigCallback(void(*func)())
{
  _savecallback = func;
}
...
void AsyncESP32_SC_W6100_Manager::setCustomHeadElement(const char* element)
{
...
// Is this an IP?
bool AsyncESP32_SC_W6100_Manager::isIp(const String& str)
{
...
// IP to String
String AsyncESP32_SC_W6100_Manager::toStringIp(const IPAddress& ip)
{
  String res = "";
...
#endif    // AsyncESP32_SC_W6100_Manager_Impl_h
