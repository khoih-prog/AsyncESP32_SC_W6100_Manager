...
void setup()
{
  ...
  AsyncESP32_SC_W6100_Manager AsyncESP32_SC_W6100_manager(&webServer, NULL, "AsyncConfigOnDoubleReset");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_W6100_Manager AsyncESP32_SC_W6100_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
#endif
